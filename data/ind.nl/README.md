...
|[urls.txt](/data/ind.nl/urls.txt)|11|Urls|
|[all_subdomains.txt](/data/ind.nl/all_subdomains.txt)|69|All found subdomains (history)|
...
|--------|-------|-------|------|------|------|------|------|------|------|------|------|------|------|------|
|[https://academie.ind.nl](https://academie.ind.nl)| **A**| **C**|Microsoft-IIS/10.0|:white_check_mark: |:white_check_mark: | | | | | :white_check_mark: | :white_check_mark: | |IIS:10.0 Windows Server|Document Moved|
...
|[https://www.academie.ind.nl](https://www.academie.ind.nl)| **A+**| **C**|Class|:white_check_mark: |:white_check_mark: | | | | | :white_check_mark: | :white_check_mark: | |HSTS||
...
|[http://localhost.ind.nl](http://localhost.ind.nl)| | **F**|nginx| | | :warning:| | | | | :white_check_mark: | |Nginx|(404 Not Found)|
