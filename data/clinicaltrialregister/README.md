...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/clinicaltrialregister/subdomains.txt)|4|Alive subdomains|
|[urls.txt](/data/clinicaltrialregister/urls.txt)|4|Urls|
|[all_subdomains.txt](/data/clinicaltrialregister/all_subdomains.txt)|4|All found subdomains (history)|
## Statistics
