...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/kamervoordebinnenvisserij/subdomains.txt)|2|Alive subdomains|
|[urls.txt](/data/kamervoordebinnenvisserij/urls.txt)|2|Urls|
|[all_subdomains.txt](/data/kamervoordebinnenvisserij/all_subdomains.txt)|2|All found subdomains (history)|
## Statistics
