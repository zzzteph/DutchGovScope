...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/trainingscatalogus.nl/subdomains.txt)|106|Alive subdomains|
|[urls.txt](/data/trainingscatalogus.nl/urls.txt)|105|Urls|
...
|[http://class-p.trainingscatalogus.nl](http://class-p.trainingscatalogus.nl)| | **C**|Microsoft-Azure-Application-Gateway/v2|:white_check_mark: |:white_check_mark: | | | | | :white_check_mark: | :white_check_mark: | |HSTS|301 Moved Perman...|
