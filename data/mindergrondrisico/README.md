...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/mindergrondrisico/subdomains.txt)|3|Alive subdomains|
|[urls.txt](/data/mindergrondrisico/urls.txt)|3|Urls|
|[all_subdomains.txt](/data/mindergrondrisico/all_subdomains.txt)|3|All found subdomains (history)|
## Statistics
