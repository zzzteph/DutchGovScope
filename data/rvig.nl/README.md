...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/rvig.nl/subdomains.txt)|34|Alive subdomains|
...
|[https://idbs.npr.idm.rvig.nl](https://idbs.npr.idm.rvig.nl)| **B**| **A**|| |:white_check_mark: | | |:warning: | :white_check_mark: | :white_check_mark: | :white_check_mark: | |HSTS|HTTP Status 500...|
