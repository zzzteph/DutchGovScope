...
|[urls.txt](/data/omgevingsloket.nl/urls.txt)|11|Urls|
...
|--------|-------|-------|------|------|------|------|------|------|------|------|------|------|------|------|
|[https://acc.omgevingsloket.nl](https://acc.omgevingsloket.nl)| **A**| **F**|Apache| | | | | | | | :white_check_mark: | |Apache HTTP Server|Access to the re...|
