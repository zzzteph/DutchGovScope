...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/jeugdinspecties.nl/subdomains.txt)|3|Alive subdomains|
|[urls.txt](/data/jeugdinspecties.nl/urls.txt)|3|Urls|
...
|[http://webmail.jeugdinspecties.nl](http://webmail.jeugdinspecties.nl)| | **F**|Microsoft-IIS/8.5| | | | | | | | :white_check_mark: | |IIS:8.5 Microsoft ASP.NET Windows Server|Access is denied...|
