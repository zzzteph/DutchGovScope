...
|--------|-------|-------|------|------|------|------|------|------|------|------|------|------|------|------|
|[https://congres.waardigheidentrots.nl](https://congres.waardigheidentrots.nl)| | **C**|Microsoft-IIS/10.0| |:white_check_mark: | | | | | | :white_check_mark: | |IIS:10.0 Windows Server|Document Moved|
|[https://waardigheidentrots.nl](https://waardigheidentrots.nl)| | **D**||:warning: |:white_check_mark: | | | | | | :white_check_mark: | |Azure Azure Front Door HSTS Microsoft ASP.NET||
...
|[https://www.waardigheidentrots.nl](https://www.waardigheidentrots.nl)| | **D**||:warning: |:white_check_mark: | | | | | | :white_check_mark: | |Azure Azure Front Door Google Tag Manager HSTS Microsoft ASP.NET|Waardigheid en t...|
