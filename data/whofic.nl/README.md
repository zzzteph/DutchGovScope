...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/whofic.nl/subdomains.txt)|3|Alive subdomains|
...
|--------|-------|-------|------|------|------|------|------|------|------|------|------|------|------|------|
|[http://class.whofic.nl](http://class.whofic.nl)| | **F**|nginx| | | | | | | | :white_check_mark: | |Nginx|301 Moved Perman...|
