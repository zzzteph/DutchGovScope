...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/cbs.nl/subdomains.txt)|222|Alive subdomains|
...
|[https://jeugdmonitor.cbs.nl](https://jeugdmonitor.cbs.nl)| **B**| **F**|nginx| | | | | | | | :white_check_mark: | |Drupal:10 HSTS Nginx PHP:8.2.18 Varnish|Home | Jeugdmoni...|
