...
|[https://staging.werkenbij.kvk.nl](https://staging.werkenbij.kvk.nl)| **B**| **A**|| |:white_check_mark: | | | | :white_check_mark: | | :white_check_mark: | |Google Tag Manager HSTS Microsoft ASP.NET|Vacatures en car...|
...
|[https://status.kvk.nl](https://status.kvk.nl)| **A+**| **A**|nginx| |:white_check_mark: | | |:warning: | | :white_check_mark: | :white_check_mark: | |HSTS Nginx|KVK Statuspagina|
