...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/rijkswaterstaatdata/subdomains.txt)|3|Alive subdomains|
|[urls.txt](/data/rijkswaterstaatdata/urls.txt)|3|Urls|
|[all_subdomains.txt](/data/rijkswaterstaatdata/all_subdomains.txt)|3|All found subdomains (history)|
## Statistics
