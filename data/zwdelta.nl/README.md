...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/zwdelta.nl/subdomains.txt)|9|Alive subdomains|
|[urls.txt](/data/zwdelta.nl/urls.txt)|7|Urls|
|[all_subdomains.txt](/data/zwdelta.nl/all_subdomains.txt)|10|All found subdomains (history)|
...
|[https://www.zwdelta.nl](https://www.zwdelta.nl)| **A+**| **C**|nginx| |:white_check_mark: | | | | | | :white_check_mark: | |Google Tag Manager HSTS MySQL Nginx PHP WordPress:6.4.3 Yoast SEO:22.3|Home - Zuidweste...|
