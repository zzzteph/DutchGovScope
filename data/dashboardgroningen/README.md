...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/dashboardgroningen/subdomains.txt)|5|Alive subdomains|
|[urls.txt](/data/dashboardgroningen/urls.txt)|5|Urls|
|[all_subdomains.txt](/data/dashboardgroningen/all_subdomains.txt)|5|All found subdomains (history)|
## Statistics
