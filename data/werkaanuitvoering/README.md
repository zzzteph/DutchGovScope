...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/werkaanuitvoering/subdomains.txt)|5|Alive subdomains|
|[urls.txt](/data/werkaanuitvoering/urls.txt)|5|Urls|
|[all_subdomains.txt](/data/werkaanuitvoering/all_subdomains.txt)|5|All found subdomains (history)|
## Statistics
