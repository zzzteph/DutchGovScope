...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/platformparticipatie/subdomains.txt)|3|Alive subdomains|
|[urls.txt](/data/platformparticipatie/urls.txt)|3|Urls|
|[all_subdomains.txt](/data/platformparticipatie/all_subdomains.txt)|3|All found subdomains (history)|
## Statistics
