...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/gezondeleefomgeving/subdomains.txt)|5|Alive subdomains|
|[urls.txt](/data/gezondeleefomgeving/urls.txt)|3|Urls|
|[all_subdomains.txt](/data/gezondeleefomgeving/all_subdomains.txt)|6|All found subdomains (history)|
## Statistics
