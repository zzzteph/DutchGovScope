...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/data/vergoedingsns.nl/subdomains.txt)|9|Alive subdomains|
|[urls.txt](/data/vergoedingsns.nl/urls.txt)|6|Urls|
|[all_subdomains.txt](/data/vergoedingsns.nl/all_subdomains.txt)|9|All found subdomains (history)|
...
|[http://aanvragen.vergoedingsns.nl](http://aanvragen.vergoedingsns.nl)| **A+**| **B**|nginx| |:white_check_mark: | | | | :white_check_mark: | | :white_check_mark: | |Nginx|301 Moved Perman...|
