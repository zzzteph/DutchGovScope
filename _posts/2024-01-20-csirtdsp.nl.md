...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/DutchGovScope/data/csirtdsp.nl/subdomains.txt)|5|Alive subdomains|
|[urls.txt](/DutchGovScope/data/csirtdsp.nl/urls.txt)|3|Urls|
|[all_subdomains.txt](/DutchGovScope/data/csirtdsp.nl/all_subdomains.txt)|5|All found subdomains (history)|
