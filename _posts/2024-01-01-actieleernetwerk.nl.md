...
|[all_subdomains.txt](/DutchGovScope/data/actieleernetwerk.nl/all_subdomains.txt)|5|All found subdomains (history)|
...
|--------|-------|-------|------|------|------|------|------|------|------|------|------|------|------|------|
|[https://www.actieleernetwerk.nl](https://www.actieleernetwerk.nl)| **A+**| **A**|nginx-rc| |:white_check_mark: | | | | :white_check_mark: | :white_check_mark: | :white_check_mark: | |HSTS Nginx WP Rocket WordPress Yoast SEO:23.3|Actie Leer Netwe...|
