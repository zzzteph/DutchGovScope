...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/DutchGovScope/data/competentnl.nl/subdomains.txt)|7|Alive subdomains|
|[urls.txt](/DutchGovScope/data/competentnl.nl/urls.txt)|4|Urls|
|[all_subdomains.txt](/DutchGovScope/data/competentnl.nl/all_subdomains.txt)|7|All found subdomains (history)|
...
|[https://opendata.competentnl.nl](https://opendata.competentnl.nl)| | **A**|nginx| |:white_check_mark: | | | | :white_check_mark: | :white_check_mark: | :white_check_mark: | |HSTS Nginx||
