...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/DutchGovScope/data/doc-direkt.nl/subdomains.txt)|10|Alive subdomains|
|[urls.txt](/DutchGovScope/data/doc-direkt.nl/urls.txt)|9|Urls|
|[all_subdomains.txt](/DutchGovScope/data/doc-direkt.nl/all_subdomains.txt)|18|All found subdomains (history)|
...
|[https://doc-direkt.nl](https://doc-direkt.nl)| **A+**| **A**|nginx| |:white_check_mark: | | |:warning: | :white_check_mark: | :white_check_mark: | :white_check_mark: | |HSTS Nginx||
