...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/DutchGovScope/data/kolonialecollecties.nl/subdomains.txt)|9|Alive subdomains|
...
|--------|-------|-------|------|------|------|------|------|------|------|------|------|------|------|------|
|[https://kolonialecollecties.nl](https://kolonialecollecties.nl)| | **C**|Apache/2| |:white_check_mark: | | | | | | :white_check_mark: | |Apache HTTP Server:2 HSTS|Commissie Koloni...|
|[https://www.kolonialecollecties.nl](https://www.kolonialecollecties.nl)| | **C**|Apache/2| |:white_check_mark: | | | | | | :white_check_mark: | |Apache HTTP Server:2 HSTS|Commissie Koloni...|
