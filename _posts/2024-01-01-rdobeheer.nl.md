...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/DutchGovScope/data/rdobeheer.nl/subdomains.txt)|63|Alive subdomains|
|[urls.txt](/DutchGovScope/data/rdobeheer.nl/urls.txt)|63|Urls|
...
|[http://max.acc.dusi.rdobeheer.nl](http://max.acc.dusi.rdobeheer.nl)| | **A**|| |:white_check_mark: | | | :white_check_mark:| :white_check_mark: | | :white_check_mark: | |HSTS||
