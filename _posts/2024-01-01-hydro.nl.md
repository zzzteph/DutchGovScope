...
| File       | Count | Info |
|------------|-------|------|
|[subdomains.txt](/DutchGovScope/data/hydro.nl/subdomains.txt)|0|Alive subdomains|
|[urls.txt](/DutchGovScope/data/hydro.nl/urls.txt)|0|Urls|
|[all_subdomains.txt](/DutchGovScope/data/hydro.nl/all_subdomains.txt)|3|All found subdomains (history)|
