...
|[all_subdomains.txt](/DutchGovScope/data/helpdeskbouwregels.nl/all_subdomains.txt)|4|All found subdomains (history)|
...
|[https://helpdeskbouwregels.nl](https://helpdeskbouwregels.nl)| | **F**|Microsoft-IIS/10.0| | | | | | | | :white_check_mark: | |Azure HSTS IIS:10.0 Microsoft ASP.NET Windows Server|Home | Veelgeste...|
